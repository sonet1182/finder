  ...
  const filterBox = (
    <>
      ...
      <div className="sidebar-filters">
        ...
        <div className="filter-block mb-10">
          <h6 className="medium-heading mb-15">ধরন</h6>
          <div className="form-group">
            <ul className="list-checkbox">
              <li>
                <label className="cb-container">
                  ...
                  />
                  <span className="text-small">সকল</span>
              ...
              <li>
                <label className="cb-container">
                  ...
                  />
                  <span className="text-small">মানুষ/ব্যাক্তি</span>
                  <span className="checkmark"></span>
                </label>
                <span className="number-item">
                  <FaHome />
              ...
              <li>
                <label className="cb-container">
                  ...
                  />
                  <span className="text-small">পোষা প্রানী</span>
                  <span className="checkmark"></span>
                </label>
                <span className="number-item">
                  <FaDesktop />
              ...
              <li>
                <label className="cb-container">
                  <input
                    ...
                    checked={query.type == "Online" ? "checked" : ""}
                  />
                  <span className="text-small">বস্তু</span>
                  <span className="checkmark"></span>
                </label>
                <span className="number-item">
                  <FaDesktop />

    ...
    <>
      <div className="mb-40">
        <h2 className="mt-5 mb-10">
          আপনি কি অন্য কারো হারিয়ে যাওয়া জিনিসটি খুঁজে পেয়েছেন?
        </h2>
        <p className="font-md color-text-paragraph-2">
          আপনি যদি জিনিসটি তার প্রকৃত মালিক কে ফিরিয়ে দিতে চান,
        ...
        >
          <h4 className="mb-2">সন্ধান পাওয়া বস্তু/ব্যাক্তির বিবরণঃ</h4>
          <div
            className="row"
            data-wow-delay=".1s"
            style={{
          ...
          >
            ...
            <div className="col-lg-6 col-md-6">
              <div className="input-style mb-20">
                <label htmlFor="s_districts">
                  খুঁজে পাওয়ার তারিখ (সাম্ভাব্য) <span className="required">*</span>
                </label>
                <input
                  className="font-sm color-text-paragraph-2"
                  name="date"
            ...
            <div className="col-lg-6 col-md-6">
              <div className="input-style mb-20">
                <label htmlFor="s_districts">
                খুঁজে পাওয়ার সময় (সাম্ভাব্য) <span className="required">*</span>
                </label>
                <input
                  className="font-sm color-text-paragraph-2"
                  name="time"
            ...
            <div className="col-lg-6 col-md-6">
              <div className="input-style mb-20">
                <label htmlFor="s_districts">
                খুঁজে পাওয়ার স্থান <span className="required">*</span>
                </label>
                <input
                  className="font-sm color-text-paragraph-2"
                  name="text"
